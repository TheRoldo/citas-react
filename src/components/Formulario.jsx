    ...
    <div className="md:w-1/2 lg:w-2/5 mx-5">
        ...
        <form onSubmit={handleSubmit} className="bg-white shadow-md rounded-lg py-10 px-5 mb-10">
          ...
          <div className="mb-5">
            ...
            <label htmlFor="sintomas" className="block text-gray-700 uppercase font-bold">Síntomas del Paciente</label>
          ...
          <input type="submit" className="bg-indigo-600 w-full p-3 text-white uppercase font-bold rounded-lg hover:bg-indigo-800 cursor-pointer transition-colors" value={ paciente.id ? 'Guardar Paciente' : 'Agregar Paciente' } />
